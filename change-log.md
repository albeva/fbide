...
- Added code completion at the start of a statement — symbols, types and library/constant/preprocessor keywords (toggle in Settings → General; Ctrl+Space to invoke).
