...
void wxStyledTextCtrl::SetMarginBackN(int margin, const wxColour& back)
{
    SendMsg(SCI_SETMARGINBACKN, margin, wxColourAsLong(back));
}

// Retrieve the background colour of a margin
wxColour wxStyledTextCtrl::GetMarginBackN(int margin) const
{
...
void wxStyledTextCtrl::SetMargins(int margins)
{
    SendMsg(SCI_SETMARGINS, margins, 0);
}

// How many margins are there?.
int wxStyledTextCtrl::GetMargins() const
{
...
{
    return SendMsg(SCI_GETPROPERTYINT, (sptr_t)(const char*)wx2stc(key), defaultValue);
}
