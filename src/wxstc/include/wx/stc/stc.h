...
public:
    ...
    void SetMarginBackN(int margin, const wxColour& back);

    // Retrieve the background colour of a margin
    wxColour GetMarginBackN(int margin) const;
    ...
    int GetPropertyInt(const wxString& key, int defaultValue) const;
