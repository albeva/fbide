...
auto TreeParser::parse(const std::vector<Token>& tokens, ProgramTree&& recycle) -> ProgramTree {
...
auto TreeParser::lastSignificantKeyword() const -> KeywordKind {
...
void TreeParser::openBlockOrStatement() {
...
auto TreeParser::isBodyDefinition() const -> bool {
